...
class CartManager {
    ...
    addCart = async (products) => {
        try {
            ...
            if (!resultProducts) return { status: 'error', message: 'producto no encontrado' };
            ...
            return { status: 'success', message: 'carrito enviado' };
        }
        catch (err) {
            console.log(err.message);
            return { status: 'error', message: err.message };
    ...
    addProductInCart = async (cid, productFromBody) => {
        ...
        try {
            ...
            return { status: 'success', message: 'CArrito Updateado ', products: cartResult };
        }
        catch (err) {
            console.log(err.message);
            return { status: 'error', message: err.message };
